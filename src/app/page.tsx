...
export default function Home() {
  ...
  return (
    <div style={{ width: '100%', overflow: 'hidden', position: 'relative' }}>
      ...
      {/* 1. Hero Section (Full width gradient backdrop with strategy glow spheres) */}
      <section className="hero-section animate-fade-in" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)', position: 'relative', overflow: 'hidden', padding: '120px 0 100px', borderBottom: '1px solid var(--card-border)' }}>
        {/* Glow meshes */}
        <div style={{ position: 'absolute', top: '-10%', left: '10%', width: '500px', height: '500px', background: 'radial-gradient(circle, rgba(99, 102, 241, 0.1) 0%, transparent 70%)', filter: 'blur(80px)', pointerEvents: 'none', zIndex: 0 }} />
        <div style={{ position: 'absolute', bottom: '-10%', right: '10%', width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(249, 115, 22, 0.06) 0%, transparent 70%)', filter: 'blur(90px)', pointerEvents: 'none', zIndex: 0 }} />
      ...
      {/* 2. Our Experiences Section (Slate Gray alternate background row) */}
      <section className="section-padding" style={{ background: '#f8fafc', borderBottom: '1px solid var(--card-border)' }}>
        <div className="container">
          <div className="text-center" style={{ marginBottom: '50px' }}>
            ...
            <h2 className="section-title" style={{ fontSize: '2.5rem', fontWeight: 800, marginTop: '10px' }}>Play. Connect. Bond.</h2>
            <p className="section-subtitle" style={{ maxWidth: '600px', margin: '10px auto 0' }}>
              We turn board games and strategy challenges into genuine human connection.
            </p>
          </div>
          
          <div className="grid-3">
            <div className="corp-card scroll-reveal delay-1" style={{ background: '#ffffff', borderRadius: '20px', padding: '35px', border: '1px solid var(--card-border)', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
              <div className="card-icon" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(99, 102, 241, 0.06)', padding: '12px', borderRadius: '12px', color: 'var(--color-brand)' }}>
              ...
              <h3 style={{ fontSize: '1.35rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: '20px', marginBottom: '12px' }}>Curated Game Nights</h3>
            ...
            <div className="corp-card scroll-reveal delay-2" style={{ background: '#ffffff', borderRadius: '20px', padding: '35px', border: '1px solid var(--card-border)', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
              <div className="card-icon" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(99, 102, 241, 0.06)', padding: '12px', borderRadius: '12px', color: 'var(--color-brand)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3 style={{ fontSize: '1.35rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: '20px', marginBottom: '12px' }}>Corporate Team Bonding</h3>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, fontSize: '0.95rem', margin: 0 }}>
                Custom-built offsites, icebreakers, and events designed to improve collaboration, build trust, and break team silos.
              </p>
            </div>

            <div className="corp-card scroll-reveal delay-3" style={{ background: '#ffffff', borderRadius: '20px', padding: '35px', border: '1px solid var(--card-border)', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
              <div className="card-icon" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(99, 102, 241, 0.06)', padding: '12px', borderRadius: '12px', color: 'var(--color-brand)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3 style={{ fontSize: '1.35rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: '20px', marginBottom: '12px' }}>Trivia & Tournaments</h3>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, fontSize: '0.95rem', margin: 0 }}>
      ...
      {/* 3. Curated Experience Packages Section (Pure White alternate background row) */}
      <section className="section-padding" style={{ background: '#ffffff', borderBottom: '1px solid var(--card-border)' }}>
        <div className="container">
          <div className="text-center" style={{ marginBottom: '50px' }}>
            ...
            <h2 className="section-title" style={{ fontSize: '2.5rem', fontWeight: 800, marginTop: '10px' }}>Curated Experience Packages</h2>
            <p className="section-subtitle" style={{ maxWidth: '600px', margin: '10px auto 0' }}>
          ...
          <div className="grid-3">
            <div className="corp-card scroll-reveal delay-1" style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#ffffff', padding: '35px', border: '1px solid var(--card-border)', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
              ...
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: '5px', marginBottom: '15px' }}>Standard Package</h3>
              <div style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--accent-primary)', marginBottom: '20px', letterSpacing: '-0.5px' }}>
                ₦250,000
              </div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, color: 'var(--text-secondary)', fontSize: '0.9rem', display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '30px' }}>
              ...
              <Link href="/booking" style={{ marginTop: 'auto' }}>
                <button className="btn-secondary" style={{ width: '100%', padding: '12px', borderRadius: '8px' }}>Choose Standard</button>
              </Link>
            </div>

            <div className="corp-card scroll-reveal delay-2" style={{ display: 'flex', flexDirection: 'column', height: '100%', border: '2px solid var(--color-brand)', background: '#ffffff', padding: '35px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(99, 102, 241, 0.04)' }}>
              ...
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: '5px', marginBottom: '15px' }}>Cocktail Package</h3>
              <div style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--accent-primary)', marginBottom: '20px', letterSpacing: '-0.5px' }}>
                ₦800,000
              </div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '25px', flexGrow: 1 }}>
              ...
              <Link href="/booking" style={{ marginTop: 'auto' }}>
                <button className="btn-primary" style={{ width: '100%', padding: '12px', borderRadius: '8px' }}>Choose Cocktail</button>
              </Link>
            </div>

            <div className="corp-card scroll-reveal delay-3" style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#ffffff', padding: '35px', border: '1px solid var(--card-border)', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
              ...
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-primary)', marginTop: '5px', marginBottom: '15px' }}>Fiesta Package</h3>
              <div style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--accent-primary)', marginBottom: '20px', letterSpacing: '-0.5px' }}>
                ₦1,200,000
              </div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '25px', flexGrow: 1 }}>
              ...
              <Link href="/booking" style={{ marginTop: 'auto' }}>
                <button className="btn-secondary" style={{ width: '100%', padding: '12px', borderRadius: '8px' }}>Choose Fiesta</button>
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* 4. Value Proposition Section (Slate Gray alternate background row) */}
      <section className="section-padding" style={{ background: '#f8fafc', borderBottom: '1px solid var(--card-border)' }}>
        <div className="container">
          <div className="grid-2">
            <div className="scroll-reveal delay-1">
              ...
              <h2 className="section-title" style={{ fontSize: '2.5rem', fontWeight: 800, marginTop: '10px' }}>Interactive Play That Drives Connection</h2>
              ...
              <ul style={{ listStyle: 'none', padding: 0, color: 'var(--text-primary)', fontSize: '1.05rem', display: 'flex', flexDirection: 'column', gap: '18px', fontWeight: 600 }}>
                ...
                <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                  ...
                  <span style={{ lineHeight: 1.5 }}>Expert game masters who coordinate learning and matchmaking</span>
                </li>
                <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                  <span style={{ 
                    display: 'inline-flex', 
                  ...
                  <span style={{ lineHeight: 1.5 }}>Live scoreboard tracking of standings and team standings</span>
                </li>
              </ul>
            </div>
      ...
      {/* 5. Bottom CTA Section (Branded gradient row) */}
      <section className="cta-section scroll-reveal" style={{ background: 'linear-gradient(135deg, var(--color-brand) 0%, var(--color-orange) 100%)', color: 'white', padding: '100px 20px', textAlign: 'center' }}>
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <h2 style={{ fontSize: '3rem', fontWeight: 800, marginBottom: '20px', color: 'white', letterSpacing: '-1px' }}>Ready to Elevate Your Gathering?</h2>
          <p style={{ fontSize: '1.2rem', opacity: 0.95, maxWidth: '600px', margin: '0 auto 40px', lineHeight: 1.6, color: 'rgba(255,255,255,0.9)' }}>
            Join the organizers and innovators who trust GamesHut to deliver unforgettable tabletop experiences.
          </p>
          <Link href="/booking">
            <button className="btn-cta" style={{ background: '#ffffff', color: 'var(--color-brand)', fontWeight: 800, border: 'none', padding: '16px 36px', borderRadius: '8px', cursor: 'pointer', fontSize: '1rem', transition: 'all 0.25s' }}>
