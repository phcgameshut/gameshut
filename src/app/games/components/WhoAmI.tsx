...
export default function WhoAmI({ challenge, onComplete }: { challenge: DailyChallenge, onComplete: (score: number, resultData: any) => void }) {
  ...
  return (
    <div className="corp-card" style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
      <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '20px' }}>Who Am I?</h3>
      <p style={{ marginBottom: '20px', color: 'var(--text-secondary)' }}>Guess the personality using progressive hints.</p>
      
      {/* Real Who Am I logic goes here */}
      <div style={{ background: 'var(--bg-secondary)', padding: '40px', borderRadius: '12px', marginBottom: '20px' }}>
        [ Who Am I Hints Placeholder ]
      </div>
