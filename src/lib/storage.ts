...
export const storage = {
  ...
  setPlayers(players: Player[]) {
    ...
    this.syncServer("players", players);
  },
  ...
  setApplications(apps: Application[]) {
    ...
    this.syncServer("applications", apps);
  },
  ...
  setProducts(products: Product[]) {
    ...
    this.syncServer("products", products);
  },
  ...
  setTickets(tickets: Ticket[]) {
    ...
    this.syncServer("tickets", tickets);
  },
  ...
  setNotifications(notifications: AppNotification[]) {
    ...
    this.syncServer("notifications", notifications);
  },
  ...
  setEmailLogs(logs: EmailLog[]) {
    ...
    this.syncServer("email_logs", logs);
  },
  ...
  setWithdrawals(withdrawals: WithdrawalRequest[]) {
    if (!isBrowser) return;
    localStorage.setItem(KEYS.WITHDRAWALS, JSON.stringify(withdrawals));
    this.syncServer("withdrawals", withdrawals);
  },
